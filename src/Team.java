...
public class Team {
    ...
    //Метод преодоления препятствия. Препятствие передается каждому игроку, и если тот имеет возможность его пройти
    //(зависит от массива PlayersAction[]) - игрок пытается преодолеть препятствие.
